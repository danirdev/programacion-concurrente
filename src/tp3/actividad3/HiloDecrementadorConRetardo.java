...
/**
 * Hilo que decrementa un contador con retardo aleatorio
 * Hereda de Thread para implementación con hilos
 * @author PC2025
 */
public class HiloDecrementadorConRetardo extends Thread {
    ...
    /**
     * Constructor del hilo decrementador con retardo
     ...
     */
    public HiloDecrementadorConRetardo(ContadorConRetardo contador, String nombre, int numOperaciones) {
     ...
     * @param nombre nombre identificador del hilo
     */
    public HiloDecrementadorConRetardo(ContadorConRetardo contador, String nombre) {
     ...
     * @param contador referencia al contador compartido
     */
    public HiloDecrementadorConRetardo(ContadorConRetardo contador) {
        this(contador, "HiloDecrementadorConRetardo", 100);
    }
    
    /**
     * Método run que ejecuta el hilo
     * Decrementa el contador el número especificado de veces con retardo aleatorio
     */
    @Override
    public void run() {
        System.out.println("[" + nombre + "] Iniciando " + numOperaciones + 
                          " decrementos con retardo aleatorio...");
        
        long tiempoInicio = System.currentTimeMillis();
        
        for (int i = 0; i < numOperaciones; i++) {
            try {
                contador.decrementar(); // Incluye retardo aleatorio interno
